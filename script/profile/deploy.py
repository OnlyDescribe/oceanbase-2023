...
if __name__ == "__main__":
    ...
    parser.add_argument("--cluster-home-path", dest='cluster_home_path', type=str, help="the path of sys log / config file / sql.sock / audit info", default="/data/obcluster")
    ...
    _logger.info('all done: %s ms' % ((end - begin).total_seconds() * 1000))
